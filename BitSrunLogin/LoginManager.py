...
class LoginManager:
	def __init__(self,
		url_login_page = "http://202.204.105.195/srun_portal_pc?ac_id=1&theme=default",
		url_get_challenge_api = "http://202.204.105.195/cgi-bin/get_challenge",
		url_login_api = "http://202.204.105.195/cgi-bin/srun_portal",
		n = "200",
		vtype = "1",
		acid = "1",
		enc = "srun_bx1"
	...
	def _get_challenge(self):
		...
		params_get_challenge = {
			"callback": "jQuery112408225023932242841", # This value can be any string, but cannot be absent
